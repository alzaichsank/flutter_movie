...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult failure(NetworkException error),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult success(T data),
    TResult failure(NetworkException error),
...
class _$FailureCopyWithImpl<T, $Res> extends _$ApiResultCopyWithImpl<T, $Res>
  ...
  $Res call({
    ...
    return _then(Failure<T>(
      error: error == freezed ? _value.error : error as NetworkException,
    ));
  }
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure({@required NetworkException error}) = _$Failure<T>;
